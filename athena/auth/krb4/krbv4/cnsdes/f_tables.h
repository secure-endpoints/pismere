 ...
 * declarations in des_tables.c (f_tables.c ?) as well.
 */  

extern unsigned KRB_INT32 des_IP_table[256];
extern unsigned KRB_INT32 des_FP_table[256];
extern unsigned KRB_INT32 des_SP_table[8][64];
...
#define	DES_IP_LEFT_BITS(left, right) \
	((((unsigned KRB_INT32)(left) & 0x55555555) << 1) | ((unsigned KRB_INT32) (right) & 0x55555555))
#define	DES_IP_RIGHT_BITS(left, right) \
	(((unsigned KRB_INT32)(left) & 0xaaaaaaaa) | \
