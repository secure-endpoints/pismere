/*
 * $Source: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/getpwtkt.c,v $
 * $Author: dalmeida $
 *
...
"$Header: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/getpwtkt.c,v 1.1 1999/03/12 23:05:41 dalmeida Exp $";
#endif /* lint */
...
int krb_get_pw_tkt(user,instance,realm,cpw)   
