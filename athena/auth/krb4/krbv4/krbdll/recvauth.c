/*
 * $Source: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/recvauth.c,v $
 * $Author: dalmeida $
 *
...
"$Header: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/recvauth.c,v 1.1 1999/03/12 23:06:11 dalmeida Exp $";
#endif  lint
...
#ifdef OS2
#define read(d,buf,n) recv((d),(buf),(n),0)
#endif
