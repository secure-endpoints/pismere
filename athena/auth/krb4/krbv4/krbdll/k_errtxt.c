/*
 * $Source: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/k_errtxt.c,v $
 * $Author: dalmeida $
 *
...
char **get_krb_err_txt()
{
        return krb_err_txt;
}

/* 2-24-93, pbh */
LPSTR FAR PASCAL get_krb_err_txt_entry(int i){
    return( krb_err_txt[i]);
}
