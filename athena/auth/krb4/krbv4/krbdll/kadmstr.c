/*
 * $Source: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/kadmstr.c,v $
 * $Author: dalmeida $
 *
...
"$Header: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/kadmstr.c,v 1.1 1999/03/12 23:05:50 dalmeida Exp $";
#endif  /* lint */
