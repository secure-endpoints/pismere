/*
 * $Source: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/ext_tkt.c,v $
 * $Author: dalmeida $
 *
...
"$Header: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/ext_tkt.c,v 1.1 1999/03/12 23:05:35 dalmeida Exp $";
#endif /* lint */
