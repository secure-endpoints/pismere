/*
 * $Source: /cvs/pismere/pismere/athena/auth/krb4/krbv4/kuser/kinit/kinit.c,v $
 * $Author: dalmeida $ 
 *
...
"$Id: kinit.c,v 1.1 1999/07/23 20:33:09 dalmeida Exp $";
#endif	lint
