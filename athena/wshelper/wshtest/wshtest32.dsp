# Microsoft Developer Studio Project File - Name="wshtest32" - Package Owner=<4>
...
# ADD LINK32 wshelp32.lib wsock32.lib /nologo /subsystem:windows /machine:I386 /libpath:"../wshelper/$(OUTDIR)"
...
# ADD LINK32 wshelp32.lib wsock32.lib /nologo /subsystem:windows /debug /machine:I386 /pdbtype:sept /libpath:"../wshelper/$(OUTDIR)"

!ENDIF 

# Begin Target

# Name "wshtest32 - Win32 Release"
# Name "wshtest32 - Win32 Debug"
