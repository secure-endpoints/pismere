...
handle_t ccapi_IfHandle;


static const RPC_CLIENT_INTERFACE ccapi___RpcClientInterface =
    {
...
RPC_IF_HANDLE ccapi_ClientIfHandle = (RPC_IF_HANDLE)& ccapi___RpcClientInterface;

extern const MIDL_STUB_DESC ccapi_StubDesc;

static RPC_BINDING_HANDLE ccapi__MIDL_AutoBindHandle;
    ...
    /* [out] */ HCTX *pctx)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&ccapi_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[0],
                 ( unsigned char * )&pctx);
    return ( CC_INT32  )_RetVal.Simple;
    ...
    /* [in] */ CRED_UNION cred)
{
    ...
    RpcTryFinally
        ...
        if(cache != 0)
            {
            _Handle = NDRCContextBinding(( NDR_CCONTEXT  )cache);;
        ...
        _RetVal = *(( CC_INT32 * )_StubMsg.Buffer)++;
    ...
    /* [out][in] */ HCRED_ITER *piter)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&ccapi_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[506],
                 ( unsigned char * )&piter);
    return ( CC_INT32  )_RetVal.Simple;
    ...
    /* [string][in] */ CC_CHAR *name)
{
    ...
    _RetVal = NdrClientCall(
                 ...
                 ( unsigned char * )&name);
    return ( CC_UINT32  )_RetVal.Simple;
...
static const MIDL_STUB_DESC ccapi_StubDesc = 
    {
    (void *)& ccapi___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &ccapi_IfHandle,
    0,
