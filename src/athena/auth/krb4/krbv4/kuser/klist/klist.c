/*
 * $Source: /cvs/pismere/pismere/athena/auth/krb4/krbv4/kuser/klist/klist.c,v $
 * $Author: dalmeida $ 
 *
...
"$Header: /cvs/pismere/pismere/athena/auth/krb4/krbv4/kuser/klist/klist.c,v 1.1 1999/07/23 20:33:11 dalmeida Exp $";
#endif	lint
