/*
 * $Source: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/crauthre.c,v $
 * $Author: dalmeida $
 *
...
"$Header: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/crauthre.c,v 1.1 1999/03/12 23:05:31 dalmeida Exp $";
#endif /* lint */
