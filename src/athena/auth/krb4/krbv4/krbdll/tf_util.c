...
#ifdef COMMENT
    /*
     *   This code empties the Kerberos 4 credential cache prior to storing
     *   each and every ticket with a service of "krbtgt".  Cross realm tickets
     *   have a service name of "krbtgt".  This results in the initial TGT being
     *   destroyed along with every other service ticket.  This has been commented
     *   out for the KfW 2.5 release.  
     *   jaltman@mit.edu
     */
