/*
 * $Source: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/g_svctkt.c,v $
 * $Author: dalmeida $
 *
...
"$Header: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/g_svctkt.c,v 1.1 1999/03/12 23:05:36 dalmeida Exp $";
#endif /* lint */
