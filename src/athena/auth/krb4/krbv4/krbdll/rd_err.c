/*
 * $Source: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/rd_err.c,v $
 * $Author: dalmeida $
 *
...
"$Header: /cvs/pismere/pismere/athena/auth/krb4/krbv4/krbdll/rd_err.c,v 1.1 1999/03/12 23:06:08 dalmeida Exp $";
#endif /* lint */
